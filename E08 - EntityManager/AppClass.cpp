...
void Application::InitVariables(void)
{
	...
	m_pEntityMngr->SetModelMatrix(glm::translate(vector3(0.0f, -21.5f, 0.0f)));
...
void Application::Update(void)
{
	...
	matrix4 mCreeper = glm::translate(m_v3Creeper) * ToMatrix4(m_qCreeper) * ToMatrix4(m_qArcBall) * glm::scale(vector3(0.03f, 0.03f, 0.03f));
